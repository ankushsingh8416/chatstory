...
declare module 'vue-router' {
  interface RouteMeta {
    ...
    requiresSuperAdmin?: boolean // Cross-tenant admin pages, gated on is_super_admin rather than a per-org permission
  }
}
    ...
    },
    {
      ...
      children: [
        ...
        },
        {
          ...
          component: () => import('@/views/admin/OrganizationsListView.vue'),
...
router.beforeEach(async (to, _from, next) => {
  ...
  if (to.meta.requiresAuth !== false) {
    ...
    // Check super-admin-only access (cross-tenant admin pages, not a per-org permission)
