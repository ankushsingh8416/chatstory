...
const (
	...
	ResourceDataConnections         = "data_connections"
...
const (
	...
	ActionPickup  = "pickup"
	ActionAssign  = "assign"
	ActionReset   = "reset" // used for users:reset (reset another user's password)
)
...
func DefaultPermissions() []Permission {
	return []Permission{
		...
		{Resource: ResourceUsers, Action: ActionReset, Description: "Reset another user's password"},
		...
		// Data Connections (org's own external DB/vector-store credentials)
		{Resource: ResourceDataConnections, Action: ActionRead, Description: "View data connections"},
		{Resource: ResourceDataConnections, Action: ActionWrite, Description: "Create and edit data connections"},
		{Resource: ResourceDataConnections, Action: ActionDelete, Description: "Delete data connections"},
		{Resource: ResourceDataConnections, Action: ActionExecute, Description: "Test data connections"},

		// Knowledge Base (documents ingested for chatbot RAG)
		{Resource: ResourceKnowledgeBase, Action: ActionRead, Description: "View knowledge bases and documents"},
		{Resource: ResourceKnowledgeBase, Action: ActionWrite, Description: "Create knowledge bases and upload/ingest documents"},
		{Resource: ResourceKnowledgeBase, Action: ActionDelete, Description: "Delete knowledge bases and documents"},
	}
}
...
func SystemRolePermissions() map[string][]string {
	...
	managerPermissions := []string{
		...
		// Data Connections
		"data_connections:read", "data_connections:write", "data_connections:delete", "data_connections:execute",
		// Knowledge Base
